...
// Header styles
if ( ! function_exists( 'boxwp_header_style' ) ) :
function boxwp_header_style() {
    ...
    <?php else : ?>
        .boxwp-site-title, .boxwp-site-title a, .boxwp-site-description {color: #<?php echo esc_attr( $header_text_color ); ?>;}
    <?php endif; ?>
    </style>
    <?php
}
