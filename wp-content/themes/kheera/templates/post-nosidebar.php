<?php
	...
	*
	* This is the template that displays single post without any sidebars .
	*
	* @package Kheera
	*/
	...
	<main id="primary" class="content-container container">
		...
		<article <?php post_class('single-col-container');?> itemprop="blogPost" itemscope itemtype="https://schema.org/BlogPosting">
